...
type ListArchivedChannelDescsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// A list of channel.
	Channeldesc   []*ChannelSettingItem `protobuf:"bytes,1,rep,name=channeldesc,proto3" json:"channeldesc,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListArchivedChannelDescsResponse) GetChanneldesc() []*ChannelSettingItem {
	if x != nil {
		return x.Channeldesc
	}
	return nil
...
const file_api_proto_rawDesc = "" +
	...
	"\vchanneldesc\x18\x01 \x03(\v2\x1d.mezon.api.ChannelSettingItemR\vchanneldesc\"\xd6\x04\n" +
	"\x04Role\x12\x0e\n" +
...
var file_api_proto_depIdxs = []int32{
	...
	232, // 55: mezon.api.ListArchivedChannelDescsResponse.channeldesc:type_name -> mezon.api.ChannelSettingItem
