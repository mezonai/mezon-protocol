...
type ApiRequestEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Api           int32                  `protobuf:"varint,1,opt,name=api,proto3" json:"api,omitempty"`
...
func (x *ApiRequestEvent) GetApi() int32 {
	if x != nil {
		return x.Api
	}
	return 0
...
var file_realtime_proto_rawDesc = []byte{
	...
	0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x37, 0x0a, 0x0f, 0x41, 0x70, 0x69,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x10, 0x0a, 0x03,
	0x61, 0x70, 0x69, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x61, 0x70, 0x69, 0x12, 0x12,
